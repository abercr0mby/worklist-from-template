sap.ui.define([
		...
		return BaseController.extend("mycompany.myapp.controller.Worklist", {
			...
			onInit : function () {
			    ...
			    this._mFilters = {
			       "starr": [new sap.ui.model.Filter("Name", FilterOperator.Contains, "Starr")],
			       "king": [new sap.ui.model.Filter("Name", FilterOperator.Contains,"King")],
			       "all": []
			    };				
			...
			onUpdateFinished : function (oEvent) {
				...
				if (iTotalItems && oTable.getBinding("items").isLengthFinal()) {
					sTitle = this.getResourceBundle().getText("worklistTableTitleCount", [iTotalItems]);
				      ...
				      this.getModel().read("/scustomSet/$count", {
				      ...
				      this.getModel().read("/scustomSet/$count", {
				         success: function (oData) {
				            oViewModel.setProperty("/starr", oData);
				         },
				         filters: this._mFilters.starr
				      });
				      // read the count for the outOfStock filter
				      this.getModel().read("/scustomSet/$count", {
				         success: function(oData){
				            oViewModel.setProperty("/king", oData);
				         },
				         filters: this._mFilters.king
				      });  
				} else {
